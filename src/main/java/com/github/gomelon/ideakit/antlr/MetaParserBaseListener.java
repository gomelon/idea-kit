...
/**
 * This class provides an empty implementation of {@link MetaParserListener},
 * which can be extended to create a listener which only needs to handle a subset
 * of the available methods.
 */
public class MetaParserBaseListener implements MetaParserListener {
    /**
     * {@inheritDoc}
     *
     ...
     */
    @Override
    public void enterRoot(MetaParser.RootContext ctx) {
    }
     ...
     */
    @Override
    public void exitRoot(MetaParser.RootContext ctx) {
    }
     ...
     */
    @Override
    public void enterSingleLine(MetaParser.SingleLineContext ctx) {
    }
     ...
     */
    @Override
    public void exitSingleLine(MetaParser.SingleLineContext ctx) {
    }
     ...
     */
    @Override
    public void enterMultipleLine(MetaParser.MultipleLineContext ctx) {
    }
     ...
     */
    @Override
    public void exitMultipleLine(MetaParser.MultipleLineContext ctx) {
    }
     ...
     */
    @Override
    public void enterFieldExpr(MetaParser.FieldExprContext ctx) {
    }
     ...
     */
    @Override
    public void exitFieldExpr(MetaParser.FieldExprContext ctx) {
    }
     ...
     */
    @Override
    public void enterFieldNameValueExpr(MetaParser.FieldNameValueExprContext ctx) {
    }
     ...
     */
    @Override
    public void enterBoolValue(MetaParser.BoolValueContext ctx) {
    }
     ...
     */
    @Override
    public void enterStrValue(MetaParser.StrValueContext ctx) {
    }
     ...
     */
    @Override
    public void enterFieldNameExpr(MetaParser.FieldNameExprContext ctx) {
    }
